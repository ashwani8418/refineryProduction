		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dangote Refinery App",
									"targetURL": "#nmrefineryconfig-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nmrefineryconfig-display": {
								"semanticObject": "nmrefineryconfig",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nm.refineryconfig",
									"url": sap.ui.require.toUrl("nm/refineryconfig")
								}
							}
						}
					}
